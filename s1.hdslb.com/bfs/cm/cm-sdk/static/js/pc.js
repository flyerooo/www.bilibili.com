! function(t) {
    ...
    function y() {
        var t = void 0,
            ...
            s = arguments.length,
            f = !1;
        for ("boolean" == typeof c && (f = c, c = arguments[1] || {}, a = 2), "object" === (void 0 === c ? "undefined" : u()(c)) || this.isFunction(c) || (c = {}), s === a && (c = this, --a); a < s; a++)
            if (null != (t = arguments[a]))
                for (e in t) n = c[e], c !== (r = t[e]) && (f && r && (this.isPlainObject(r) || (o = this.isArray(r))) ? (o ? (o = !1, i = n && this.isArray(n) ? n : []) : i = n && this.isPlainObject(n) ? n : {}, c[e] = this.extend(f, i, r)) : void 0 !== r && (c[e] = r));
        return c
    }
    ...
    var r = n(1),
        ...
        X = function(t, e, n) {
            return t === H && X(G, e, n), b(t), e = x(e, !0), b(n), o(q, e) ? (n.enumerable ? (o(t, I) && t[I][e] && (t[I][e] = !1), n = O(n, {
                enumerable: j(0, !1)
            })) : (o(t, I) || M(t, I, j(1, {})), t[I][e] = !0), V(t, e, n)) : M(t, e, n)
        },
        K = function(t, e) {
            b(t);
    ...
    window.BiliCm && window.bilicm || (window.BiliCm = window.bilicm = {}), window.ad_rp = window.bilicm.base = window.BiliCm.Base = function(t, e, n) {
        var r = {
            ...
            _cmHostname: n.CM_BILIBILI_HOSTNAME,
            ...
            _genMark: function(t, e) {
                ...
                if (e && n)
                    if ("[object Array]" === n.call(e))
                        for (var o = 0; o < e.length; o++) r.push(e[o]);
                    else "[object String]" === n.call(e) && r.push(e);
                return r.join("|")
            },
            ...
            _genReqPostOps: function(t, e, n, r, i, c) {
                var u = o()(this._genReqOpsPro(e, n, r)),
                    s = Object(a.b)() || {};
                return {
                    url: t,
                    type: "POST",
                    data: s.msie && parseInt(s.version, 10) <= 9 ? {
                        message: u
                    } : u,
                    headers: {
            ...
            _removeItem: function(t, e) {
                for (var n = this._genMark(e), r = 0, o = t.length; r < o; r++)
                    if (this._genMark(t[r]) === n) return t.splice(r, 1), !0;
                return !1
            },
            _hitCmReport: function(t, e) {
                var n = Object(a.a)({}, t.data, {
                    ts: this._getNowTs(),
                    _: parseInt(1e6 * Math.random(), 10)
                });
            ...
            _checkedRepeat: function(t) {
                for (var e = this._cached, n = 0, r = e.length; n < r; n++)
                    if (e[n] === t) return !0;
                return !1
            },
    ...
    c.isArray = b, c.isFunction = function(t) {
        ...
        var e, n = c.extend({}, t || {}),
            r = c.Deferred && c.Deferred(),
            o = void 0;
        for (u in c.ajaxSettings) void 0 === n[u] && (n[u] = c.ajaxSettings[u]);
        n.crossDomain || ((o = a.createElement("a")).href = n.url, n.crossDomain = v.protocol + "//" + v.host != o.protocol + "//" + o.host), n.url || (n.url = window.location.toString()), (e = n.url.indexOf("#")) > -1 && (n.url = n.url.slice(0, e)),
            function(t) {
        ...
        var y = n.accepts[i],
            ...
            m = /^([\w-]+:)\/\//.test(n.url) ? RegExp.$1 : window.location.protocol,
            g = n.xhr(),
            w = g.setRequestHeader,
            S = void 0;
        if (r && r.promise(g), n.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", y || "*/*"), (y = n.mimeType || y) && (y.indexOf(",") > -1 && (y = y.split(",", 2)[0]), g.overrideMimeType && g.overrideMimeType(y)), (n.contentType || !1 !== n.contentType && n.data && "GET" !== n.type.toUpperCase()) && b("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers)
            for (s in n.headers) b(s, n.headers[s]);
        g.setRequestHeader = b, g.onreadystatechange = function() {
            if (4 === g.readyState) {
                ...
                if (g.status >= 200 && g.status < 300 || 304 === g.status || 0 === g.status && "file:" === m) {
                    if (i = i || ((o = n.mimeType || g.getResponseHeader("content-type")) && (o = o.split(";", 2)[0]), o && (o === d ? "html" : o === p ? "json" : f.test(o) ? "script" : l.test(o) && "xml") || "text"), "arraybuffer" === g.responseType || "blob" === g.responseType) t = g.response;
                    else {
                        t = g.responseText;
                        try {
                            t = function(t, e, n) {
        ...
        if (g.open(n.type, n.url, T, n.username, n.password), n.xhrFields)
            for (s in n.xhrFields) g[s] = n.xhrFields[s];
    ...
    function k(t) {
        ...
        var r = t.callback || "_jsonpCallback_" + (new Date).getTime(),
