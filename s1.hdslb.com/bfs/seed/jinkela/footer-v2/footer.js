! function(t) {
    ...
    function d(t, e) {
        for (var n = [], r = {}, i = 0; i < t.length; i++) {
            ...
            r[a] ? r[a].parts.push(A) : n.push(r[a] = {
                id: a,
                parts: [A]
            })
        }
    ...
    (function(t, n) {
        ...
        var P, Z = "__proto__" in {},
            ...
            X = V && V.indexOf("edge/") > 0,
            tt = (V && V.indexOf("android"), V && /iphone|ipad|ipod|ios/.test(V) || "ios" === W),
            et = (V && /chrome\/\d+/.test(V), V && /phantomjs/.test(V), V && V.match(/firefox\/(\d+)/)),
            nt = {}.watch,
            rt = !1;
        if (J) try {
            var it = {};
        ...
        function ye(t, e) {
            ...
            if (Array.isArray(t) || "string" == typeof t)
                ...
                if (ct && t[Symbol.iterator]) {
                    ...
                    for (a = Object.keys(t), n = new Array(a.length), r = 0, i = a.length; r < i; r++) A = a[r], n[r] = e(t[A], A, r);
                ...
                if (s(t) && (t = l.extend(t)), "function" == typeof t) {
                    ...
                    if (a(t.options.functional)) return function(t, e, n, i, a) {
                        var A = t.options,
                            ...
                            c = A.props;
                        if (o(c))
                            for (var l in c) s[l] = Lt(l, c, e || r);
                        else o(n.attrs) && Fe(s, n.attrs), o(n.props) && Fe(s, n.props);
                        var u = new De(n, s, a, i, t),
        ...
        function Ue(t, e, n, r, c, l) {
            return (Array.isArray(n) || A(n)) && (c = r, r = n, n = void 0), a(l) && (c = 2),
                function(t, e, n, r, A) {
        ...
        function en(t, e) {
            ...
            var n = t.$options[e],
                r = e + " hook";
            if (n)
                for (var i = 0, o = n.length; i < o; i++) Pt(n[i], t, null, t, r);
        ...
        function fn() {
            ...
            var n = rn.slice(),
                r = nn.slice();
            sn = nn.length = rn.length = 0, on = {}, an = An = !1,
                function(t) {
        ...
        ! function(t) {
            ...
            Object.defineProperty(t, "config", e), t.util = {
                ...
                })), t.options._base = t, I(t.options.components, Tn),
                function(t) {
                    t.use = function(t) {
        ...
        var Qn = h("style,class"),
            ...
            Fn = h("contenteditable,draggable,spellcheck"),
        ...
        function cr(t, e) {
            (t.data.directives || e.data.directives) && function(t, e) {
                ...
                if (!o)
                    for (n in A) s[n] || pr(A[n], "unbind", t, t, a)
            }(t, e)
        }
        ...
        function $r(t) {
            ...
            else if (124 !== e || 124 === t.charCodeAt(r + 1) || 124 === t.charCodeAt(r - 1) || l || u || f) {
                switch (e) {
                    case 34:
                        A = !0;
                        break;
            ...
            if (void 0 === i ? i = t.slice(0, r).trim() : 0 !== p && h(), o)
        ...
        var ci, li = /^--/,
            ui = /\s*!important$/,
                ...
                else if (ui.test(n)) t.style.setProperty(E(e), n.replace(ui, ""), "important");
                else {
                    var r = di(e);
                    if (Array.isArray(n))
        ...
        function vi(t, e) {
            ...
            if (!(i(n.staticStyle) && i(n.style) && i(r.staticStyle) && i(r.style))) {
                ...
                var p = function(t, e) {
                    var n, r = {};
                    if (e)
                        for (var i = t; i.componentInstance;)(i = i.componentInstance._vnode) && i.data && (n = Ai(i.data)) && I(r, n);
                    (n = Ai(t.data)) && I(r, n);
        ...
        var Ui = function(t) {
            ...
            for (e = 0; e < or.length; ++e)
                for (r[or[e]] = [], n = 0; n < s.length; ++n) o(s[n][or[e]]) && r[or[e]].push(s[n][or[e]]);
                        ...
                        if (o(A)) {
                            ...
                            if (o(A = A.hook) && o(A = A.init) && A(t, !1), o(t.componentInstance)) return f(t, e), p(n, t.elm, i), a(s) && function(t, e, n, i) {
                                ...
                                for (; A.componentInstance;)
                                    if (A = A.componentInstance._vnode, o(a = A.data) && o(a = a.transition)) {
            ...
            return function(t, e, n, A) {
                if (!i(e)) {
                    ...
                    if (i(t)) l = !0, u(e, f);
                        ...
                        var p = o(t.nodeType);
                        if (!p && ar(t, e)) k(t, e, f, null, null, A);
                        else {
                            if (p) {
                            ...
                            var d = t.elm,
                                h = c.parentNode(d);
                            if (u(e, f, d._leaveCb ? null : h, c.nextSibling(d)), o(e.parent))
        ...
        function Hi(t, e, n) {
            ...
            if (!i || Array.isArray(r)) {
                for (var o, a, A = 0, s = t.options.length; A < s; A++)
                    if (a = t.options[A], i) o = F(r, Zi(a)) > -1, a.selected !== o && (a.selected = o);
                    else if (M(Zi(a), r)) return void(t.selectedIndex !== A && (t.selectedIndex = A));
                i || (t.selectedIndex = -1)
            }
        }
            ...
            io = {
                ...
                render: function(t) {
                    ...
                    if (n && (n = n.filter(no)).length) {
                        ...
                        var s = (o.data || (o.data = {})).transition = to(this),
                            c = this._vnode,
                            l = Xi(c);
        ...
        var No, Lo, Uo, Yo, Ro, Ho, Po, Zo, Jo = /^@|^v-on:/,
            zo = /^v-|^@|^:|^#/,
        ...
        function Aa(t, e) {
            ...
            function l(t) {
                if (u(t), s || t.processed || (t = sa(t, e)), o.length || t === r || r.if && (t.elseif || t.else) && la(r, {
                    ...
                    if (t.elseif || t.else) a = t, (A = function(t) {
                        for (var e = t.length; e--;) {
                            if (1 === t[e].type) return t[e];
                            t.pop()
                        }
                    }(i.children)) && A.if && la(A, {
                        exp: a.elseif,
                        block: a
                    });
                    else {
            ...
            return function(t, e) {
                ...
                function C(t, n, o) {
                    ...
                    if (null == n && (n = s), null == o && (o = s), t)
                        for (A = t.toLowerCase(), a = i.length - 1; a >= 0 && i[a].lowerCasedTag !== A; a--);
                    else a = 0;
                    if (a >= 0) {
        ...
        function sa(t, e) {
            ...
            ! function(t) {
                ...
                }(t), "slot" === (n = t).tag && (n.slotName = jr(n, "name")),
                function(t) {
                    var e;
            ...
            return function(t) {
                ...
                for (e = 0, n = c.length; e < n; e++) {
                    if (r = i = c[e].name, o = c[e].value, zo.test(r))
                        ...
                        else if (Jo.test(r)) r = r.replace(Jo, ""), (s = qo.test(r)) && (r = r.slice(1, -1)), Gr(t, r, o, a, !1, 0, c[e], s);
                    else {
        ...
        function Oa(t) {
            ...
            var e = xa.test(t.value),
                n = Ba.test(t.value),
                r = xa.test(t.value.replace(ka, ""));
            if (t.modifiers) {
                var i = "",
                    o = "",
                    a = [];
                for (var A in t.modifiers)
                    if (Sa[A]) o += Sa[A], Ca[A] && a.push(A);
                    else if ("exact" === A) {
                    var s = t.modifiers;
        ...
        var Ka, qa, Xa = (Ka = function(t, e) {
            ...
            tA = (Xa.compile, Xa.compileToFunctions);
    ...
    var u = function(t, e, n, r, i, o, a, A) {
            ...
            var t = this,
                ...
                n = t._self._c || e;
            return n("div", {
                staticClass: "international-footer"
            }, [n("div", {
                ...
                staticClass: "link-item link-a"
            }, [n("span", {
                staticClass: "bt"
            }, [t._v(t._s(t.$lang[6]))]), n("ul", [n("a", {
                attrs: {
                    target: "_blank",
            ...
            }, [t._v(t._s(t.$lang[7]))])])]), n("div", {
                staticClass: "link-item link-b"
            }, [n("span", {
                staticClass: "bt"
            }, [t._v(t._s(t.$lang[8]))]), n("ul", [n("a", {
                attrs: {
                    target: "_blank",
                ...
                staticClass: "link-item link-c"
            }, [n("div", {
                staticClass: "a-wraper"
            }, [n("a", {
                staticClass: "biliapp",
                attrs: {
                ...
                staticClass: "bili-footer-font bili-footer-icon_download"
            }), n("p", [t._v(t._s(t.$lang[17]))]), n("div", {
                staticClass: "qrcode"
            })])]), n("div", {
                staticClass: "a-wraper"
            }, [n("a", {
                staticClass: "weibo",
                attrs: {
                    href: "//weibo.com/bilibiliweb",
                    target: "_blank"
                }
            }, [n("i", {
                staticClass: "bili-footer-font bili-footer-icon_weibo"
            }), n("p", [t._v(t._s(t.$lang[18]))]), n("div", {
                staticClass: "qrcode"
            })])]), n("div", {
                staticClass: "a-wraper"
            }, [n("a", {
                ...
                staticClass: "bili-footer-font bili-footer-icon_wechat"
            }), n("p", [t._v(t._s(t.$lang[19]))]), n("div", {
                staticClass: "qrcode"
            })])])])])]), n("div", {
