...
var Sentry = function(n) {
    ...
    ! function(n) {
    ...
    }(u || (u = {})), (c = n.Severity || (n.Severity = {})).Fatal = "fatal", c.Error = "error", c.Warning = "warning", c.Log = "log", c.Info = "info", c.Debug = "debug", c.Critical = "critical",
        function(n) {
        ...
        }(n.Severity || (n.Severity = {})), (s = n.Status || (n.Status = {})).Unknown = "unknown", s.Skipped = "skipped", s.Success = "success", s.RateLimit = "rate_limit", s.Invalid = "invalid", s.Failed = "failed",
        function(n) {
    ...
    function x() {
        return g() ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : E
    }
    ...
    function D(n) {
        try {
            for (var t = n, r = [], e = 0, i = 0, o = " > ".length, u = void 0; t && e++ < 5 && !("html" === (u = I(t)) || e > 1 && i + r.length * o + u.length >= 80);) r.push(u), i += u.length, t = t.parentNode;
    ...
    var U, A = C.__SENTRY__.logger || (C.__SENTRY__.logger = new M),
        L = function() {
            function n() {
    ...
    function H(n, t) {
        return r = t, "[object RegExp]" === Object.prototype.toString.call(r) ? t.test(n) : "string" == typeof t && -1 !== n.indexOf(t);
        var r
    }
    ...
    function W(n) {
        ...
        if (m(n)) {
            ...
            i.type = n.type;
            try {
                i.target = w(n.target) ? D(n.target) : Object.prototype.toString.call(n.target)
            } catch (n) {
                i.target = "<unknown>"
            }
            try {
                i.currentTarget = w(n.currentTarget) ? D(n.currentTarget) : Object.prototype.toString.call(n.currentTarget)
            } catch (n) {
                i.currentTarget = "<unknown>"
            }
            for (var e in "undefined" != typeof CustomEvent && n instanceof CustomEvent && (i.detail = n.detail), n) Object.prototype.hasOwnProperty.call(n, e) && (i[e] = n[e]);
            return i
        }
        return n
    }
    ...
    function X(n, t) {
        return "domain" === t && "object" == typeof n && n.u ? "[Domain]" : "domainEmitter" === t ? "[DomainEmitter]" : "undefined" != typeof global && n === global ? "[Global]" : "undefined" != typeof window && n === window ? "[Window]" : "undefined" != typeof document && n === document ? "[Document]" : y(r = n) && "nativeEvent" in r && "preventDefault" in r && "stopPropagation" in r ? "[SyntheticEvent]" : "number" == typeof n && n != n ? "[NaN]" : void 0 === n ? "[undefined]" : "function" == typeof n ? "[Function: " + (n.name || "<unknown-function-name>") + "]" : n;
        var r
    }

    function G(n, t, r, e) {
        if (void 0 === r && (r = 1 / 0), void 0 === e && (e = new L), 0 === r) return function(n) {
        ...
        for (var c in o) Object.prototype.hasOwnProperty.call(o, c) && (u[c] = G(c, o[c], r - 1, e));
    ...
    var V = function() {
            function n(n) {
                var t = this;
                this.s = U.PENDING, this.h = [], this.v = function(n) {
                    t.l(U.RESOLVED, n)
                }, this.p = function(n) {
                    t.l(U.REJECTED, n)
                }, this.l = function(n, r) {
                    t.s === U.PENDING && (b(r) ? r.then(t.v, t.p) : (t.s = n, t.m = r, t.g()))
                }, this.j = function(n) {
                    t.h = t.h.concat(n), t.g()
                }, this.g = function() {
                    t.s !== U.PENDING && (t.s === U.REJECTED ? t.h.forEach(function(n) {
        ...
        K = function() {
            ...
            return n.prototype.isReady = function() {
                ...
                var t = this;
                return this.isReady() ? (-1 === this.S.indexOf(n) && this.S.push(n), n.then(function() {
                    return t.remove(n)
                }).then(null, function() {
                    return t.remove(n).then(null, function() {})
                }), n) : V.reject(new f("Not adding Promise due to buffer limit reached."))
    ...
    var Z = /^[ \t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \t]*$/,
        nn = function() {
            function n(n, t, r, e) {
                void 0 === n && (n = j()), void 0 === t && (t = j().substring(16)), this.O = n, this.k = t, this.T = r, this.R = e
            }
        ...
        tn = function() {
            function n() {
                this.D = !1, this.I = [], this.C = [], this.N = [], this.M = {}, this.U = {}, this.A = {}, this.L = {}
            }
            return n.prototype.addScopeListener = function(n) {
                ...
                var o = this;
                return void 0 === i && (i = 0), new V(function(u, c) {
                    var s = n[i];
                    if (null === t || "function" != typeof s) u(t);
                    else {
                        var a = s(e({}, t), r);
                        b(a) ? a.then(function(t) {
                            return o.F(n, t, r, i + 1).then(u)
                        }).then(null, c) : o.F(n, a, r, i + 1).then(u).then(null, c)
                    }
                })
                ...
                var r;
                return this.U = e({}, this.U, ((r = {})[n] = J(t), r)), this.q(), this
            }, n.prototype.setExtras = function(n) {
                return this.A = e({}, this.A, J(n)), this.q(), this
            }, n.prototype.setExtra = function(n, t) {
                var r;
                return this.A = e({}, this.A, ((r = {})[n] = J(t), r)), this.q(), this
                ...
                var r = new n;
                return t && (r.N = o(t.N), r.U = e({}, t.U), r.A = e({}, t.A), r.L = e({}, t.L), r.M = t.M, r.P = t.P, r.B = t.B, r.W = t.W, r.H = t.H, r.C = o(t.C)), r
            }, n.prototype.clear = function() {
                return this.N = [], this.U = {}, this.A = {}, this.M = {}, this.L = {}, this.P = void 0, this.W = void 0, this.H = void 0, this.B = void 0, this.q(), this
            }, n.prototype.addBreadcrumb = function(n, t) {
                var r = (new Date).getTime() / 1e3,
                    i = e({
                        timestamp: r
                    }, n);
                return this.N = void 0 !== t && t >= 0 ? o(this.N, [J(i)]).slice(-t) : o(this.N, [J(i)]), this.q(), this
    ...
    var on = 3,
        un = function() {
            function n(n, t, r) {
                void 0 === t && (t = new tn), void 0 === r && (r = on), this.X = r, this.G = [], this.G.push({
                    client: n,
                    scope: t
                })
            }
            return n.prototype.J = function(n) {
                ...
                return this.J("captureException", n, e({}, i, {
                    event_id: r
                })), r
                ...
                return this.J("captureMessage", n, t, e({}, o, {
                    event_id: i
                })), i
            }, n.prototype.captureEvent = function(n, t) {
                var r = this.V = j();
                return this.J("captureEvent", n, e({}, t, {
                    event_id: r
                })), r
                ...
                try {
                    ...
                    return A.warn("Cannot retrieve integration " + n.id + " from the current Hub"), null
                }
    ...
    function an() {
        var n = cn();
        return fn(n) && !hn(n).isOlderThan(on) || vn(n, new un), g() ? function(n) {
            try {
    ...
    function hn(n) {
        return n && n.__SENTRY__ && n.__SENTRY__.hub ? n.__SENTRY__.hub : (n.__SENTRY__ = n.__SENTRY__ || {}, n.__SENTRY__.hub = new un, n.__SENTRY__.hub)
    }
        ...
        yn = function() {
            ...
            return n.prototype.toString = function(n) {
                ...
                var r = i(t.slice(1), 6),
                    ...
                    l = r[5],
                    d = l.split("/");
                d.length > 1 && (v = d.slice(0, -1).join("/"), l = d.pop()), this.Y({
                    host: s,
                    pass: c,
                    path: v,
                    projectId: l,
                ...
                if (this.port && isNaN(parseInt(this.port, 10))) throw new f("Invalid Dsn")
            }, n
        }(),
        mn = function() {
            function n(n) {
    ...
    function bn(n) {
        ...
        return function(n) {
            ...
            t[n.name] = n,
                function(n) {
                    -1 === wn.indexOf(n.name) && (n.setupOnce(en, an), wn.push(n.name), A.log("Integration installed: " + n.name))
                }(n)
        }), t
    }
    var gn, En = function() {
            function n(n, t) {
                this.rn = {}, this.en = !1, this.in = new n(t), this.on = t, t.dsn && (this.un = new yn(t.dsn)), this.cn() && (this.rn = bn(this.on))
            }
            return n.prototype.captureException = function(n, t, r) {
                ...
                try {
                    ...
                    return A.warn("Cannot retrieve integration " + n.id + " from the current Client"), null
                }
                ...
                var i = this.getOptions(),
                    ...
                    a = void 0 === s ? 250 : s,
                    f = e({}, n);
                void 0 === f.environment && void 0 !== o && (f.environment = o), void 0 === f.release && void 0 !== u && (f.release = u), void 0 === f.dist && void 0 !== c && (f.dist = c), f.message && (f.message = q(f.message, a));
                var h = f.exception && f.exception.values && f.exception.values[0];
                h && h.value && (h.value = q(h.value, a));
                var v = f.request;
                v && v.url && (v.url = q(v.url, a)), void 0 === f.event_id && (f.event_id = j()), this.vn(f.sdk);
                var l = V.resolve(f);
                ...
                var e = this,
                    ...
                    o = i.beforeSend,
                    u = i.sampleRate;
                return this.cn() ? "number" == typeof u && Math.random() > u ? V.reject("This event has been sampled, will not send event.") : new V(function(i, u) {
                    e.hn(n, r, t).then(function(n) {
                        if (null !== n) {
                            ...
                            try {
                                ...
                                var c = o(n, t);
                                if (void 0 === c) A.error("`beforeSend` method has to return `null` or a valid event.");
                                else if (b(c)) e.ln(c, i, u);
                                else {
                                    if (null === (r = c)) return A.log("`beforeSend` returned `null`, will not send event."), void i(null);
        ...
        jn = function() {
            function n(n) {
                this.on = n, this.on.dsn || A.warn("No DSN provided, backend will not do anything."), this.dn = this.pn()
            }
    ...
    var _n = function() {
        ...
        On = function() {
            ...
            return n.prototype.setupOnce = function() {
                ...
                return void 0 === t && (t = {}), !(!t.ignoreErrors || !t.ignoreErrors.length) && this.jn(n).some(function(n) {
                ...
                return void 0 === n && (n = {}), {
                    ...
                    ignoreErrors: o(this.on.ignoreErrors || [], n.ignoreErrors || [], Sn),
        ...
        Tn = "?",
        Rn = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[-a-z]+:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        Dn = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js))(?::(\d+))?(?::(\d+))?\s*$/i,
        In = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
            ...
            if (t = function(n) {
                    ...
                    for (var t, r, e, i = [], o = n.stack.split("\n"), u = 0; u < o.length; ++u) {
                        if (r = Rn.exec(o[u])) {
                            ...
                            r[2] && 0 === r[2].indexOf("eval") && (t = Nn.exec(r[2])) && (r[2] = t[1], r[3] = t[2], r[4] = t[3]), e = {
                                url: r[2],
                                func: r[1] || Tn,
                                args: c ? [r[2]] : [],
                                line: r[3] ? +r[3] : null,
                            ...
                            r[3] && r[3].indexOf(" > eval") > -1 && (t = Cn.exec(r[3])) ? (r[1] = r[1] || "eval", r[3] = t[1], r[4] = t[2], r[5] = "") : 0 !== u || r[5] || void 0 === n.columnNumber || (i[0].column = n.columnNumber + 1), e = {
                                url: r[3],
                                func: r[1] || Tn,
                                args: r[2] ? r[2].split(",") : [],
                                line: r[4] ? +r[4] : null,
    ...
    function Pn(n, t, r) {
        var e, i;
        if (void 0 === r && (r = {}), v(n) && n.error) return e = Fn(Mn(n = n.error));
        if (l(n) || (i = n, "[object DOMException]" === Object.prototype.toString.call(i))) {
            var o = n,
                u = o.name || (l(o) ? "DOMError" : "DOMException"),
                c = o.message ? u + ": " + o.message : u;
            return k(e = Wn(c, t, r), c), e
        }
        return h(n) ? e = Fn(Mn(n)) : y(n) || m(n) ? (T(e = function(n, t, r) {
            var e = {
                exception: {
                    values: [{
                        type: m(n) ? n.constructor.name : r ? "UnhandledRejection" : "Error",
                        value: "Non-Error " + (r ? "promise rejection" : "exception") + " captured with keys: " + z(n)
                    }]
                },
                extra: {
                    __serialized__: $(n)
    ...
    var Bn, $n, Xn = function() {
            function n(n) {
                this.options = n, this.S = new K(30), this.url = new mn(this.options.dsn).getStoreEndpointWithUrlEncodedAuth()
            }
        ...
        Jn = function(t) {
            ...
            return r(e, t), e.prototype.sendEvent = function(t) {
                ...
                return this.S.add(Gn.fetch(this.url, r).then(function(t) {
                    return {
        ...
        zn = function(t) {
            ...
            return r(e, t), e.prototype.sendEvent = function(t) {
                var r = this;
                return this.S.add(new V(function(e, i) {
        ...
        Kn = function(t) {
            ...
            return r(i, t), i.prototype.pn = function() {
                ...
                var n = e({}, this.on.transportOptions, {
                    dsn: this.on.dsn
                });
                return this.on.transport ? new this.on.transport(n) : Q() ? new Jn(n) : new zn(n)
                ...
                return T(e, {
                    handled: !0,
                    type: "generic"
                }), e.level = n.Severity.Error, r && r.event_id && (e.event_id = r.event_id), V.resolve(e)
            }, i.prototype.eventFromMessage = function(t, r, e) {
                void 0 === r && (r = n.Severity.Info);
                var i = Wn(t, e && e.syntheticException || void 0, {
                    attachStacktrace: this.on.attachStacktrace
                });
                return i.level = r, e && e.event_id && (i.event_id = e.event_id), V.resolve(i)
            }, i
        }(jn),
                    ...
                    if (this.cn()) {
                        ...
                        if (n.eventId)
                            if (r) {
                                ...
                                e.async = !0, e.src = new mn(r).getReportDialogEndpoint(n), n.onLoad && (e.onload = n.onLoad), (t.head || t.body).appendChild(e)
                            } else A.error("Missing `Dsn` option in showReportDialog call");
                        else A.error("Missing `eventId` option in showReportDialog call")
                    } else A.error("Trying to call showReportDialog with Sentry Client is disabled")
            }, t
        }(En),
        Zn = 1e3,
        nt = 0;
    ...
    function rt(n, t, r) {
        ...
        var sentryWrapped = function() {
            ...
            try {
                ...
                throw nt += 1, setTimeout(function() {
                    nt -= 1
                }), dn(function(r) {
                    r.addEventProcessor(function(n) {
                        var r = e({}, n);
                        return t.mechanism && (k(r, void 0, void 0), T(r, t.mechanism)), r.extra = e({}, r.extra, {
                            arguments: J(i, 3)
                        }), r
                    }), captureException(n)
                }), n
    ...
    function ot() {
        return function(n) {
            ...
            var r = t && t.tagName;
            r && ("INPUT" === r || "TEXTAREA" === r || t.isContentEditable) && (Bn || it("input")(n), clearTimeout(Bn), Bn = setTimeout(function() {
                Bn = void 0
            }, Zn))
        }
    }
    var ut = function() {
            function t(n) {
                this.name = t.id, this._n = x(), this.Sn = null, this.On = null, this.kn = !1, this.Tn = !1, this.on = e({
                    onerror: !0,
                    onunhandledrejection: !0
                }, n)
            }
            return t.prototype.setupOnce = function() {
                Error.stackTraceLimit = 50, this.on.onerror && (A.log("Global Handler attached: onerror"), this.Rn()), this.on.onunhandledrejection && (A.log("Global Handler attached: onunhandledrejection"), this.Dn())
            }, t.prototype.Rn = function() {
                if (!this.kn) {
                    var n = this;
                    this.Sn = this._n.onerror, this._n.onerror = function(r, e, i, o, u) {
                        var c = an(),
                            s = c.getIntegration(t),
                            a = u && !0 === u.__sentry_own_request__;
                        if (!s || tt() || a) return !!n.Sn && n.Sn.apply(this, arguments);
                        var f = c.getClient(),
                            h = p(u) ? n.In(r, e, i, o) : n.Cn(Pn(u, void 0, {
                ...
                if (!this.Tn) {
                    var r = this;
                    this.On = this._n.onunhandledrejection, this._n.onunhandledrejection = function(e) {
                        var i = e;
                        try {
                        ...
                        if (!u || tt() || c) return !!r.On && r.On.apply(this, arguments);
                        var s = o.getClient(),
                            a = p(i) ? r.Nn(i) : Pn(i, void 0, {
                                attachStacktrace: s && s.getOptions().attachStacktrace,
                                rejection: !0
                            });
                        return a.level = n.Severity.Error, T(a, {
                            handled: !1,
                ...
                return n.exception = n.exception || {}, n.exception.values = n.exception.values || [], n.exception.values[0] = n.exception.values[0] || {}, n.exception.values[0].stacktrace = n.exception.values[0].stacktrace || {}, n.exception.values[0].stacktrace.frames = n.exception.values[0].stacktrace.frames || [], 0 === n.exception.values[0].stacktrace.frames.length && n.exception.values[0].stacktrace.frames.push({
                    colno: e,
                    filename: t || R(),
                    function: "?",
                    in_app: !0,
        ...
        ct = function() {
            ...
            return n.prototype.Un = function(n) {
                ...
                var t = x(),
                    r = t[n] && t[n].prototype;
                r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (P(r, "addEventListener", function(t) {
                    return function(r, e, i) {
                        try {
                            "function" == typeof e.handleEvent && (e.handleEvent = rt(e.handleEvent.bind(e), {
                                mechanism: {
                                    data: {
                ...
                this.Mn = this.Mn;
                var n = x();
                P(n, "setTimeout", this.Un.bind(this)), P(n, "setInterval", this.Un.bind(this)), P(n, "requestAnimationFrame", this.An.bind(this)), ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"].forEach(this.Ln.bind(this))
            }, n.id = "TryCatch", n
        }();
    ...
    var at, ft = x(),
        ht = function() {
            ...
            return t.prototype.qn = function() {
                "console" in ft && ["debug", "info", "warn", "error", "log", "assert"].forEach(function(r) {
                    r in ft.console && P(ft.console, r, function(e) {
                        return function() {
                            ...
                            "assert" === r ? !1 === i[0] && (u.message = "Assertion failed: " + (F(i.slice(1), " ") || "console.assert"), u.data.extra.arguments = J(i.slice(1), 3), t.addBreadcrumb(u, {
                                input: i,
                                level: r
                            })) : t.addBreadcrumb(u, {
                                input: i,
                ...
                "document" in ft && (ft.document.addEventListener("click", it("click"), !1), ft.document.addEventListener("keypress", ot(), !1), ["EventTarget", "Node"].forEach(function(n) {
                    var t = ft[n] && ft[n].prototype;
                    t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (P(t, "addEventListener", function(n) {
                        return function(t, r, e) {
                            return r && r.handleEvent ? ("click" === t && P(r, "handleEvent", function(n) {
                                return function(t) {
                                    return it("click")(t), n.call(this, t)
                                }
                            }), "keypress" === t && P(r, "handleEvent", function(n) {
                                return function(t) {
                                    return ot()(t), n.call(this, t)
                                }
                            })) : ("click" === t && it("click", !0)(this), "keypress" === t && ot()(this)), n.call(this, t, r, e)
                        }
                ...
                (function() {
                    ...
                    return function() {
                        ...
                        var o, u = e[0],
                            c = "GET";
                        "string" == typeof u ? o = u : "Request" in ft && u instanceof Request ? (o = u.url, u.method && (c = u.method)) : o = String(u), e[1] && e[1].method && (c = e[1].method);
                        var s = an().getClient(),
                            a = s && s.getDsn();
                        if (a) {
                            var f = new mn(a).getStoreEndpoint();
                            if (f && -1 !== o.indexOf(f)) return "POST" === c && e[1] && e[1].body && vt(e[1].body), r.apply(ft, e)
                        }
                        var h = {
                            method: d(c) ? c.toUpperCase() : c,
                            url: o
                        };
                        return r.apply(ft, e).then(function(n) {
                ...
                var n = this;
                if (r = x(), e = r.chrome, i = e && e.app && e.app.runtime, o = "history" in r && !!r.history.pushState && !!r.history.replaceState, !i && o) {
                    var r, e, i, o, u = function(n, r) {
                            var e = _(ft.location.href),
                                i = _(r),
                                o = _(n);
                            o.path || (o = e), at = r, e.protocol === i.protocol && e.host === i.host && (r = i.relative), e.protocol === o.protocol && e.host === o.host && (n = o.relative), t.addBreadcrumb({
                                category: "navigation",
                                data: {
                                    from: n,
                                    to: r
                    ...
                    P(n, "open", function(n) {
                        return function() {
                            ...
                            if (o) {
                                ...
                                d(e) && u && -1 !== e.indexOf(u) && (this.__sentry_own_request__ = !0)
                            }
                        ...
                        return function() {
                            ...
                            return ["onload", "onerror", "onprogress"].forEach(function(n) {
                                ! function(n, t) {
                                    n in t && "function" == typeof t[n] && P(t, n, function(t) {
                                        return rt(t, {
                                            mechanism: {
                                                data: {
                                                    function: n,
                            ...
                            }), "onreadystatechange" in i && "function" == typeof i.onreadystatechange ? P(i, "onreadystatechange", function(n) {
                                return rt(n, {
                                    mechanism: {
                                        data: {
                ...
                this.on.console && this.qn(), this.on.dom && this.Fn(), this.on.xhr && this.Wn(), this.on.fetch && this.Hn(), this.on.history && this.Pn()
            }, t.id = "Breadcrumbs", t
        }();
    ...
    var lt = "cause",
        ...
        pt = function() {
            function n(t) {
                void 0 === t && (t = {}), this.name = n.id, this.Bn = t.key || lt, this._ = t.limit || dt
            }
            return n.prototype.setupOnce = function() {
                en(function(t, r) {
                ...
                if (void 0 === r && (r = []), !(n[t] instanceof Error) || r.length + 1 >= this._) return r;
                var e = qn(Mn(n[t]));
            ...
            return n.prototype.setupOnce = function() {
                en(function(t) {
                    if (an().getIntegration(n)) {
                        ...
                        var r = t.request || {};
                        return r.url = r.url || yt.location.href, r.headers = r.headers || {}, r.headers["User-Agent"] = yt.navigator.userAgent, e({}, t, {
                            request: r
                        })
                    }
                    return t
    ...
    var xt = e({}, gt, kn, wt);
    return n.BrowserClient = Yn, n.Hub = un, n.Integrations = xt, n.SDK_NAME = Qn, n.SDK_VERSION = "5.7.1", n.Scope = tn, n.Span = nn, n.Transports = Vn, n.addBreadcrumb = function(n) {
        ln("addBreadcrumb", n)
    }, n.addGlobalEventProcessor = en, n.captureEvent = function(n) {
        ...
        ln("configureScope", n)
    }, n.defaultIntegrations = bt, n.flush = function(n) {
        var t = an().getClient();
        return t ? t.flush(n) : V.reject(!1)
    }, n.forceLoad = function() {}, n.getCurrentHub = an, n.getHubFromCarrier = hn, n.init = function(n) {
        if (void 0 === n && (n = {}), void 0 === n.defaultIntegrations && (n.defaultIntegrations = bt), void 0 === n.release) {
            var t = x();
    ...
    }, n.withScope = dn, n.wrap = function(n) {
        return rt(n)()
    }, n
}({});
