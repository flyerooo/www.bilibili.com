<template>
  <ul id="bilibili-search-history" class="bilibili-search-history report-wrap-module" v-if="list.length > 0">
    <li v-for="(item, index) in list"
      ...
      <a
        v-text="item.value"
        :href="`//search.bilibili.com/all?keyword=${encodeURIComponent(item.value)}&from_source=webtophistory_search`"
        target="_blank"
