...
module.exports = function(t) {
                ...
                i = function(t, e) {
                    ...
                    ! function() {
                        ...
                        function O(t, e) {
                            ...
                            for (; !(o = r.next()).done;)
                                if ((i = j(e)(o.value, a++)) === p) throw m(r.return) && r.return(), i.e;
                            return a
                        }
                        ...
                        function R(t, e, n) {
                            var r = 0,
                                o = t._c;
                            if (3 === t._s)
                                for (t._s = e, t._v = n, 1 === e && (s && b(n, l) && (n.longStack = P(n, t)), k(t)); r < o;) A(t, t[r++]);
                            return t
                        }
    ...
    var r, o, i, a, c = n(5),
        ...
        Q = H,
        V = "process" == b(z),
        G = !!(J && J.createEvent && s.dispatchEvent),
        $ = N(R, (function() {
            if (!(w(F) !== String(F))) {
                if (66 === P) return !0;
    ...
    var r = n(61),
        ...
        s = function(t) {
            ...
            return function(d, h, v, g) {
                for (var y, m, b = i(d), w = o(b), x = r(h, v, 3), j = a(w.length), S = 0, O = g || c, E = e ? O(d, j) : n ? O(d, 0) : void 0; j > S; S++)
    ...
    var r = n(5),
        ...
        at = function(t, e, n) {
            t === q && at(Y, e, n), h(t);
            var r = y(e, !0);
            return h(n), l(K, r) ? (n.enumerable ? (l(t, F) && t[F][r] && (t[F][r] = !1), n = b(n, {
                enumerable: m(0, !1)
    ...
    t.exports = function(t, e, n, f, d, m, b) {
        ...
        if (I && (w = i(I.call(new t)), h !== Object.prototype && w.next && (l || i(w) === h || (a ? a(w, h) : "function" != typeof w[g] && u(w, g, y)), c(w, O, !0, !0), l && (p[O] = y))), "values" == d && A && "values" !== A.name && (E = !0, k = function() {
                return A.call(this)
            }), l && !b || C[g] === k || u(C, g, k), p[e] = k, d)
            if (x = {
                    values: S("values"),
                    keys: m ? k : S("keys"),
                    entries: S("entries")
                }, b)
                for (j in x)(v || E || !(j in C)) && s(C, j, x[j]);
            else r({
                target: e,
                proto: !0,
                forced: v || E
    ...
    r("split", 2, (function(t, e, n) {
        ...
        return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, n) {
            ...
            for (var w = 0, x = 0, j = []; x < p.length;) {
                ...
                if (null === O || (S = h(s(m.lastIndex + (v ? 0 : x)), p.length)) === w) x = u(p, x, g);
                else {
                    if (j.push(p.slice(w, x)), j.length === b) return j;
                    for (var E = 1; E <= O.length - 1; E++)
                        if (j.push(O[E]), j.length === b) return j;
                    x = w = S
                }
            }
            ...
            r("split", 2, (function(t, e, n) {
                ...
                return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, n) {
                    ...
                    for (var x = 0, j = 0, S = []; j < p.length;) {
                        ...
                        if (null === E || (O = h(s(b.lastIndex + (g ? 0 : j)), p.length)) === x) j = u(p, j, y);
                        else {
            ...
            var r = n("23e7"),
                ...
                ut = function(t, e, n) {
                    ...
                    return h(n), l(X, r) ? (n.enumerable ? (l(t, F) && t[F][r] && (t[F][r] = !1), n = b(n, {
                        enumerable: m(0, !1)
                    })) : (l(t, F) || W(t, F, m(1, {})), t[F][r] = !0), it(t, r, n)) : W(t, r, n)
                },
                st = function(t, e) {
                    h(t);
                    var n = g(e),
                        ...
                        r = function(t, e) {
                            ...
                            ! function() {
                                ...
                                function _(t, e) {
                                    ...
                                    for (; !(o = r.next()).done;)
                                        if ((i = T(e)(o.value, a++)) === w) throw C(r[g]) && r[g](), i.e;
                                    return a
                                }
    ...
    var h = function() {
        ...
        v = (n(164), n(115), n(165), n(117), h()),
        g = "IE 9" === v || "IE Legacy" === v,
        y = g || "IE 10" === v || "IE 11" === v;
    var m = {};
    var b = {},
        w = function() {
    ...
    var j = function(t, e) {
        ...
        S = (n(48), "//space.bilibili.com"),
        O = "//passport.bilibili.com",
        E = "//bangumi.bilibili.com",
        C = n(33),
        A = n.n(C);
                ...
                onInit: function() {
                    if (void 0 !== window.Promise) {
                        if (this.dealHost(), function() {
                                var t, e, n;
                                if (void 0 !== document.hidden) t = "hidden", n = "visibilitychange", e = "visibilityState";
                                else if (void 0 !== document.mozHidden) t = "mozHidden", n = "mozvisibilitychange", e = "mozVisibilityState";
                                else if (void 0 !== document.msHidden) t = "msHidden", n = "msvisibilitychange", e = "msVisibilityState";
                                else {
    ...
    var W = function(t, e, n, r, o, i, a, c) {
        ...
        return n("div", {
            ...
            staticClass: "num",
            domProps: {
                textContent: t._s(t.notify.num > 99 ? "99+" : t.notify.num)
            }
        }) : t._e(), t.notify.num && 1 === t.notify.type ? n("div", {
            staticClass: "red_point"
        }) : t._e(), t._t("default", [t._m(0)])], 2), t.floatMessage ? n("div", {
        ...
        return e("a", {
            ...
            staticClass: "bilifont bili-icon_dingdao_xiaoxi"
        })])
