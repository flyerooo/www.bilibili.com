! function(e, t) {
    ...
    return function(e) {
        ...
        e.exports = function(e, t, n, r) {
            ...
            s > 0 && u > s && (u = s);
            for (var l = 0; l < u; ++l) {
                var f, d, p, h, y = e[l].replace(c, "%20"),
                    v = y.indexOf(n);
        ...
        var i = n(2),
            ...
            f = function(e) {
                ...
                return new Promise((function(e, n) {
                    ...
                    if (i.onreadystatechange = function() {
                        ...
                        }, i.withCredentials = !0, i.open(t, c, !0), "POST" === t && o && "object" === s()(o))
                        for (var a in o) i.setRequestHeader(a, o[a]);
                    i.send(r)
                }))
            },
            d = function(e) {
            ...
            h = function() {
                ...
                return a()(e, null, [{
                    ...
                    value: function() {
                        var e = this;
                        this.cache ? this._notice(this.cache) : this.locked || (this.locked = !0, f({
                            method: "GET",
                    ...
                    value: function(e, t) {
                        ...
                        t && (o.gourl = t), f({
                            ...
                            i && i({
                                code: -1,
                                message: "XMLHttpRequest status:" + e
                            })
                        }))
                    }
                }]), e
